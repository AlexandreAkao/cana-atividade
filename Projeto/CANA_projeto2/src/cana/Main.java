...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            while (br.ready()) {
                ...
                if (lineCount == 0) {
                    ...
                    contratos = new Contrato[contratosSize];
                    ...
                    contratos[lineCount - 1] = new Contrato(contratoInfo);
        ...
        handleContrato = new HandleContrato(fornecedores, contratos, mesesCount, fornecedoresCount, contratosCountPerFornecedor);
